...
export default function Settings() {
  ...
  const { displayCurrency, setDisplayCurrency, hideAmounts, setHideAmounts } = useDisplayCurrency();
    ...
    <div className="space-y-6">
      ...
      <Card data-testid="card-appearance">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <Label htmlFor="hide-amounts">Para Miktarlarını Gizle</Label>
              <div className="text-sm text-muted-foreground">
                Tüm tutarlar <span className="font-mono font-bold">****</span> olarak gösterilir
              </div>
            </div>
            <Switch
              id="hide-amounts"
